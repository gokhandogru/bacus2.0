...
$sql = "SELECT * FROM bacus_multilingual WHERE Swedish = '$keywordfromform' OR Swedish LIKE '% $keywordfromform' OR Swedish LIKE '$keywordfromform %' OR Swedish LIKE '% $keywordfromform %' ORDER BY CHAR_LENGTH(Swedish) LIMIT 25";
...
Every project has been supervised by an expert on the subject and has been developed at least in three languages; chosen among the languages offered in our degree (Arabic, Catalan, Chinese, English, German, Italian, Japanese, Portuguese, Russian, and Spanish).</p>";
	...
	<br>
	<br>
	<center><b><a href="http://espanolturco.com/bacus/index_bacus_swedish.php">Return to Swedish term search</a></b></center>
	<?php
