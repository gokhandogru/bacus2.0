...
$sql = "SELECT * FROM bacus_multilingual WHERE Italian = '$keywordfromform' OR Italian LIKE '% $keywordfromform' OR Italian LIKE '$keywordfromform %' OR Italian LIKE '% $keywordfromform %' ORDER BY CHAR_LENGTH(Italian) LIMIT 25";
...
Every project has been supervised by an expert on the subject and has been developed at least in three languages; chosen among the languages offered in our degree (Arabic, Catalan, Chinese, English, German, Italian, Japanese, Portuguese, Russian, and Spanish).</p>";
	...
	<br>
	<br>
	<center><b><a href="http://espanolturco.com/bacus/index_bacus_italian.php">Return to Italian term search</a></b></center>
	<?php
