...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="3" selected="selected" value="http://espanolturco.com/bacus/index_bacus_catalan.php">Catalan</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_catalan.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Catalan</legend>
