...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="11" selected="selected" value="http://espanolturco.com/bacus/index_bacus_german.php">German</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_german.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in German</legend>
