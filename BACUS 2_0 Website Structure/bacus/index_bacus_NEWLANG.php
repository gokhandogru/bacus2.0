...
<html>
<!-- This page is the landing page (main page) for a language. From here, a user can search a term and the results will be shown for the search language, and other available languages. In this template, you can add a new language simply by changing the "NEWLANG" with the language you would like to add., for example "Maltese". And if you have the Maltese language column in your table in the database, you will start to see results for your search. The following code should be added to all the landing pages of other languages:

<option id="22" value="http://espanolturco.com/bacus/index_bacus_turkish.php">NEWLANG</option>

This is for internal consistency of the website
 -->
...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="13" value="http://espanolturco.com/bacus/index_bacus_japanese.php">Japanese</option>	
	...
	<option id="22" selected="selected" value="http://espanolturco.com/bacus/index_bacus_turkish.php">NEWLANG</option>
	</select>
  </div>

<br>
<br>
<form class="form-horizontal" action="/buscar_termino_NEWLANG.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in NEWLANG</legend>
