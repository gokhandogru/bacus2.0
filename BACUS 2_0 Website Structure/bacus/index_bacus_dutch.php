...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="6" selected="selected" value="http://espanolturco.com/bacus/index_bacus_dutch.php">Dutch</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_dutch.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Dutch</legend>
