...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="7" selected="selected" value="http://espanolturco.com/bacus/index_bacus_english.php">English</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_english.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in English</legend>
