...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="16" selected="selected" value="http://espanolturco.com/bacus/index_bacus_portuguese.php">Portuguese</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_portuguese.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Portuguese</legend>
