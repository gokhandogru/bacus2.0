...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="2" selected="selected" value="http://espanolturco.com/bacus/index_bacus_basque.php">Basque</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_basque.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Basque</legend>
