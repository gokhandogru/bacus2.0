...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="4" selected="selected" value="http://espanolturco.com/bacus/index_bacus_chinese.php">Chinese</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_chinese.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Chinese</legend>
