...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="20" selected="selected" value="http://espanolturco.com/bacus/index_bacus_spanish.php">Spanish</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_spanish.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Spanish</legend>
