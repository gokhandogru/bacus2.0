...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="8" selected="selected" value="http://espanolturco.com/bacus/index_bacus_englishgb.php">English_GB</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_englishgb.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in English GB</legend>
