...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="21" selected="selected" value="http://espanolturco.com/bacus/index_bacus_turkish.php">Turkish</option>
	</select>
  </div>

<br>
<br>
<form class="form-horizontal" action="/buscar_termino_turkish.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Turkish</legend>
