...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="10" selected="selected" value="http://espanolturco.com/bacus/index_bacus_galician.php">Galician</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_galician.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Galician</legend>
