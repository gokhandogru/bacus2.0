...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="19" selected="selected" value="http://espanolturco.com/bacus/index_bacus_swedish.php">Swedish</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_swedish.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Swedish</legend>
