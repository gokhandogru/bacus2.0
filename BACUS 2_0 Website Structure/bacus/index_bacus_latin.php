...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="14" selected="selected" value="http://espanolturco.com/bacus/index_bacus_latin.php">Latin</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_latin.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Latin</legend>
