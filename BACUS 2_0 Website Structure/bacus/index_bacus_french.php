...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="9" selected="selected" value="http://espanolturco.com/bacus/index_bacus_french.php">French</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_french.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in French</legend>
