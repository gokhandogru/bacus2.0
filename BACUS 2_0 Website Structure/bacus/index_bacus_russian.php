...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="18" selected="selected" value="http://espanolturco.com/bacus/index_bacus_russian.php">Russian</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_russian.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Russian</legend>
