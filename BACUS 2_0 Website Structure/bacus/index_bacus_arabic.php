...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
    ...
    <option id="1" selected="selected" value="http://espanolturco.com/bacus/index_bacus_arabic.php">Arabic</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_arabic.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Arabic</legend>
