...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="12" selected="selected" value="http://espanolturco.com/bacus/index_bacus_italian.php">Italian</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_italian.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Italian</legend>
...
<html>
<body><select onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
    <option value=""></option>
    <option value="http://espanolturco.com">İspanyolca - Türkçe</option>
    <option value="http://tr.espanolturco.com/">Türkçe - İspanyolca</option>
    <option value="http://youtube.com">Home Page</option>
</select></body></html>
