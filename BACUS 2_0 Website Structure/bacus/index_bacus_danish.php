...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="5" selected="selected" value="http://espanolturco.com/bacus/index_bacus_danish.php">Danish</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_danish.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Danish</legend>
