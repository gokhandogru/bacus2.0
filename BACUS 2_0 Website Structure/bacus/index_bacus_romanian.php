...
<div>
  ...
  <select class="browser-default" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
	...
	<option id="17" selected="selected" value="http://espanolturco.com/bacus/index_bacus_romanian.php">Romanian</option>
...
<br>
<br>
<form class="form-horizontal" action="/buscar_termino_romanian.php">
<fieldset>

<!-- Form Name -->
<legend>Search term in Romanian</legend>
