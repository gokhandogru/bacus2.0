...
$sql = "SELECT * FROM bacus_multilingual WHERE Spanish = '$keywordfromform' OR Spanish LIKE '% $keywordfromform' OR Spanish LIKE '$keywordfromform %' OR Spanish LIKE '% $keywordfromform %' ORDER BY CHAR_LENGTH(Spanish) LIMIT 25";
...
<center><b><a href="http://espanolturco.com/bacus/index_bacus_spanish.php">Return to Spanish term search</a></b></center>
